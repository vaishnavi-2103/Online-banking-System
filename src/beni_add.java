 ...
 * @author Vaishnavi
 */
public class beni_add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BENIFICARY NAME");
        ...
        jLabel3.setText("BENFICARY NICKNAME");
 ...
 new beni_add().setVisible(true);        // TODO add your handling code here:
 ...
 new trans_resetpwd().setVisible(true);        // TODO add your handling code here:
  ...
  Connection conn1 = null;
        ...
        String nickname= jTextField2.getText();
         String accountno= jTextField3.getText();
        String ifsc= jTextField4.getText();
         String branch= jTextField5.getText();
           try
    {
         
            String two = "insert into bank_beni(beni_name,beni_nickname,beni_accno,beni_ifsc,beni_branch) values('" + name + "','" + nickname + "','" +accountno + "','" +ifsc+ "','" + branch +"');";
     ...
     catch(ClassNotFoundException | NumberFormatException | SQLException ax)
     {

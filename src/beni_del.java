 ...
 * @author Vaishnavi
 */
public class beni_del extends javax.swing.JFrame {
 ...
 new trans_resetpwd().setVisible(true);        // TODO add your handling code here:
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try
        {
            ...
            String two ="delete from bank_beni where beni_name='"+name+"' and  beni_accno='"+accountno+"';";
            ...
            this.setVisible(false);
              JOptionPane.showMessageDialog(this,"Deleted Succesfully ","info", JOptionPane.INFORMATION_MESSAGE);

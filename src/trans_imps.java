 ...
 * @author Vaishnavi
 */
public class trans_imps extends javax.swing.JFrame {
 ...
 new trans_resetpwd().setVisible(true);        // TODO add your handling code here:
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try
        {
            ...
            String two = "insert into bank_transfer(transaction_date ,transfer_from  ,transfer_to,amount ,mode_of_transfer) values('" + date+ "','" + from + "','" +to+ "','" +amount+ "','Imps Transfer' );";

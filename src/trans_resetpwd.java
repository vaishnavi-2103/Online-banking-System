 ...
 * @author Vaishnavi
 */
public class trans_resetpwd extends javax.swing.JFrame {

    /**
     * Creates new form home
     */
    public trans_resetpwd() {
        initComponents();
    }

    trans_resetpwd(String message) {
 ...
 new trans_resetpwd().setVisible(true);        // TODO add your handling code here:
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try{
            ...
            String one = "update   login_bank set   password= '"+newpass+"' where password='"+oldpass+"';";
            Statement stmt1 = conn1.createStatement();
            stmt1.executeUpdate(one);
            
                 JOptionPane.showMessageDialog(this,"Password Updated  Succesfully ","info", JOptionPane.INFORMATION_MESSAGE);
            ...
            System.out.print(ex);
            //  jTextField4.setText("invalid user");
        }

 ...
 * @author Vaishnavi
 */
public class trans_self extends javax.swing.JFrame {
...
Connection conn1=null;
              ...
              try
    {
            ...
            String two = "insert into bank_transfer(transaction_date ,transfer_from  ,transfer_to,amount ,mode_of_transfer) values('" + date+ "','" + from + "','" +to+ "','" +amount+ "','Self  Transfer' );";
